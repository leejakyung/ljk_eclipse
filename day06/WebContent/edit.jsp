<%@ page language="java" contentType="text/html; charset=UTF-8"
	pageEncoding="UTF-8"%>
<jsp:useBean id="data" class="model.letter.LetterVO" scope="request" />
...
<input type="hidden" name="lnum" value="<%=data.getLnum()%>">
	<table border="1">
		<tr>
			<td>작성자</td>
		...
		<tr>
			<td>작성일</td>
			<td><input type="date" name="wdate" value="<%=data.getWriter()%>"></td>
